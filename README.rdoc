...
This release of EPF Wiki is based on {EPF Wiki 1.5}[http://www.eclipse.org/downloads/download.php?file=/technology/epf/wiki/epfwiki_r1_5_20081021_0316.zip]
from the {Eclipse Process Framework (EPF)}[http://www.eclipse.org/epf] project.
...
You can now use <tt>git clone</tt> to get EPF Wiki on your box.	
...
After restart you should be able to see EPF Wiki when you navigate to http://<ip-address>:3000. 
...
Extract the contents and copy the folder tinymce\jscripts\tiny_mce to epfw\public\javascripts. 
...
<b>tiny_mce.js</b>
 ...
 ostraaten@epfw-vbox:~$ <b>ls ~/epfw/public/javascripts/tiny_mce/</b>
...
and, depending on the day of the week or month, also a weekly and/or monthly report.

The task <b>epfw:update</b> can run multiple times a day but you should enough time for it to complete a job. When
jobs overlap things get messy.
...
This job will send reports (daily, weekly, monthly) and will update Wiki sites if updates have been scheduled. 
It should run from the <b>EPF Wiki root</b>
...
* Onno van der Straaten:: upgrade to Rails 3