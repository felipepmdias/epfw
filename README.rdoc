...
of course use Github if you have a Github account. More information on EPW Wiki can be found in 
the [EPF Wiki User Guide]] and the EPF Wiki Development Guide. 

1. Ubuntu Server 10.04 LTS 32-bit
...
The script contains a bug, the fix is to add the following line to <strong>.bash_profile</strong>
...
Create a database configuration file for your installation
...
5. Apache2 and Phusion Passenger (aka mod_rails)
...
6. EPF Wiki as a virtual appliance
